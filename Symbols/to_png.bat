...
REM FORFILES /p %~dp0svg /m va*.svg /C "cmd /c C:\Progra~1\Inkscape\bin\inkscape.com @file -d 288 -y 0 -o %~dp0png_hoog\\@fname.png |echo @file hoog"
REM FORFILES /p %~dp0svg /m va*.svg /C "cmd /c C:\Progra~1\Inkscape\bin\inkscape.com @file -d 96 -y 0 -o %~dp0png_laag\\@fname.png |echo @file laag"
