...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="." >
        ...
        <xsl:text>&#xa;&#x9;background-repeat: none;</xsl:text>
        ...
        <!--
background-image: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' version='1.1' width='48px' height='24px' xml:space='preserve'><g><line style='stroke:
rgb(224,96,96,1)
; stroke-width: 
2
; stroke-dasharray: 
...
; opacity: 
1
;' y1='10' x2='58' y2='10' x1='0'/></g></svg>"); margin-right: 10px;}
-->        
