...
<xsl:stylesheet  
    ...
    <xsl:param name="symbolpath" select="'./imro_symbols/'"/>
    ...
    <xsl:template match=".[fn:substring(*[local-name() = 'Name']/text(), 1, 1)=('A','E','S')]" mode="symbol">
        <xsl:element name="td">
            <xsl:attribute name="class">rule_cap_col</xsl:attribute>
            <xsl:element name="table">
                        ...
                        <xsl:element name="svg">
                            ...
                            <xsl:element name="polygon">
                                ...
                                <xsl:attribute name="style">
                                    <!-- CssParameter of graphicFill -->
                                    <xsl:variable name="style">
                                        <xsl:choose>
                                            <xsl:when test="./*[local-name() = 'PolygonSymbolizer']/*[local-name() = 'Fill']/*[local-name() = 'CssParameter']">
                                                <xsl:variable name="fill" select="./*[local-name() = 'PolygonSymbolizer']/*[local-name() = 'Fill']/*[local-name() = 'CssParameter'][@name = 'fill']/text()"/>
                                                <xsl:variable name="fill-opacity" select="./*[local-name() = 'PolygonSymbolizer']/*[local-name() = 'Fill']/*[local-name() = 'CssParameter'][@name = 'fill-opacity']/text()"/>
                                        ...
                                        <xsl:variable name="stroke" select="./*[local-name() = 'PolygonSymbolizer']/*[local-name() = 'Stroke']/*[local-name() = 'CssParameter'][@name = 'stroke']/text()"/>
                                        <xsl:variable name="stroke-opacity" select="./*[local-name() = 'PolygonSymbolizer']/*[local-name() = 'Stroke']/*[local-name() = 'CssParameter'][@name = 'stroke-opacity']/text()"/>
                                        <xsl:variable name="stroke-width" select="./*[local-name() = 'PolygonSymbolizer']/*[local-name() = 'Stroke']/*[local-name() = 'CssParameter'][@name = 'stroke-width']/text()"/>
                                        <xsl:variable name="stroke-linejoin" select="./*[local-name() = 'PolygonSymbolizer']/*[local-name() = 'Stroke']/*[local-name() = 'CssParameter'][@name = 'stroke-linejoin']/text()"/>
                                        <xsl:variable name="stroke-dasharray" select="./*[local-name() = 'PolygonSymbolizer']/*[local-name() = 'Stroke']/*[local-name() = 'CssParameter'][@name = 'stroke-dasharray']/text()"/>
                                        <xsl:variable name="stroke-dasharray_mm" select="concat(tokenize($stroke-dasharray)[1],'mm ',tokenize($stroke-dasharray)[2],'mm ')"/>
                                        <xsl:variable name="stroke-linecap" select="./*[local-name() = 'PolygonSymbolizer']/*[local-name() = 'Stroke']/*[local-name() = 'CssParameter'][@name = 'stroke-linecap']/text()"/>
                    ...
                    <xsl:element name="td">
                        <xsl:element name="svg">
                            ...
                            <xsl:element name="line">
                                ...
                                <xsl:attribute name="style">
                                    <xsl:variable name="stroke" select="./*[local-name() = 'LineSymbolizer']/*[local-name() = 'Stroke']/*[local-name() = 'CssParameter'][@name = 'stroke']/text()"/>
                                    <xsl:variable name="stroke-opacity" select="./*[local-name() = 'LineSymbolizer']/*[local-name() = 'Stroke']/*[local-name() = 'CssParameter'][@name = 'stroke-opacity']/text()"/>
                                    <xsl:variable name="stroke-width" select="./*[local-name() = 'LineSymbolizer']/*[local-name() = 'Stroke']/*[local-name() = 'CssParameter'][@name = 'stroke-width']/text()"/>
                                    <xsl:variable name="stroke-dasharray" select="./*[local-name() = 'LineSymbolizer']/*[local-name() = 'Stroke']/*[local-name() = 'CssParameter'][@name = 'stroke-dasharray']/text()"/>
                                    <xsl:variable name="stroke-dasharray_mm" select="concat(tokenize($stroke-dasharray)[1],'mm ',tokenize($stroke-dasharray)[2],'mm ')"/>
                                    <xsl:variable name="stroke-linecap" select="./*[local-name() = 'LineSymbolizer']/*[local-name() = 'Stroke']/*[local-name() = 'CssParameter'][@name = 'stroke-linecap']/text()"/>
                                ...
                                <xsl:element name="svg">
                                    ...
                                    <xsl:element name="polygon">
                                        ...
                                        <xsl:attribute name="style">
                                            ...
                                            <xsl:variable name="style">
                                                <xsl:choose>
                                                    <xsl:when test="./*[local-name() = 'PointSymbolizer']/*[local-name() = 'Graphic']/*[local-name() = 'Mark']/*[local-name() = 'Fill']/*[local-name() = 'CssParameter']">
                                                        <xsl:variable name="fill" select="./*[local-name() = 'PointSymbolizer']/*[local-name() = 'Graphic']/*[local-name() = 'Mark']/*[local-name() = 'Fill']/*[local-name() = 'CssParameter'][@name = 'fill']/text()"/>
                                                        <xsl:variable name="fill-opacity" select="./*[local-name() = 'PointSymbolizer']/*[local-name() = 'Graphic']/*[local-name() = 'Mark']/*[local-name() = 'Fill']/*[local-name() = 'CssParameter'][@name = 'fill-opacity']/text()"/>
                                                        <xsl:value-of select="concat('fill:', fn:replace(fn:replace(string(not($fill)),'true','#ffffff'),'false',string($fill)),';fill-opacity:', fn:replace(fn:replace(string(not($fill-opacity)),'true','1'),'false',string($fill-opacity)))" />
                                                    </xsl:when>
                                                    <xsl:otherwise>
                                                        <xsl:value-of select="'fill-opacity:0'"/>
                                                ...
                                                <xsl:variable name="stroke" select="./*[local-name() = 'PointSymbolizer']/*[local-name() = 'Graphic']/*[local-name() = 'Mark']/*[local-name() = 'Stroke']/*[local-name() = 'CssParameter'][@name = 'stroke']/text()"/>
                                                <xsl:variable name="stroke-opacity" select="./*[local-name() = 'PointSymbolizer']/*[local-name() = 'Graphic']/*[local-name() = 'Mark']/*[local-name() = 'Stroke']/*[local-name() = 'CssParameter'][@name = 'stroke-opacity']/text()"/>
                                                <xsl:variable name="stroke-width" select="./*[local-name() = 'PointSymbolizer']/*[local-name() = 'Graphic']/*[local-name() = 'Mark']/*[local-name() = 'Stroke']/*[local-name() = 'CssParameter'][@name = 'stroke-width']/text()"/>
                                                <xsl:variable name="stroke-linejoin" select="./*[local-name() = 'PointSymbolizer']/*[local-name() = 'Graphic']/*[local-name() = 'Mark']/*[local-name() = 'Stroke']/*[local-name() = 'CssParameter'][@name = 'stroke-linejoin']/text()"/>
                                                <xsl:variable name="stroke-dasharray" select="./*[local-name() = 'PointSymbolizer']/*[local-name() = 'Graphic']/*[local-name() = 'Mark']/*[local-name() = 'Stroke']/*[local-name() = 'CssParameter'][@name = 'stroke-dasharray']/text()"/>
                                                <xsl:variable name="stroke-linecap" select="./*[local-name() = 'PointSymbolizer']/*[local-name() = 'Graphic']/*[local-name() = 'Mark']/*[local-name() = 'Stroke']/*[local-name() = 'CssParameter'][@name = 'stroke-linecap']/text()"/>
    ...
    <xsl:template match="." mode="prop_list">
        ...
        <xsl:element name="tr">
            <!-- Fill - fill -->
            <xsl:element name="td">
                <xsl:value-of select="./*[local-name()=$geom_type]/*[local-name()='Fill']/*[local-name()='CssParameter' and @name='fill']/text()"/>
            </xsl:element>
        </xsl:element>
        <xsl:element name="tr">
            <!-- Fill - fill-opacity -->
            <xsl:element name="td">
                <xsl:value-of select="./*[local-name()=$geom_type]/*[local-name()='Fill']/*[local-name()='CssParameter' and @name='fill-opacity']/text()"/>
            </xsl:element>
        </xsl:element>
        <xsl:element name="tr">
        ...
        <xsl:element name="tr">
            <!-- Stroke - stroke -->
            <xsl:element name="td">
                <xsl:value-of select="./*[local-name()=$geom_type]/*[local-name()='Stroke']/*[local-name()='CssParameter' and @name='stroke']/text()"/>
            </xsl:element>
        </xsl:element>
        <xsl:element name="tr">
            <!-- Stroke - stroke-opacity -->
            <xsl:element name="td">
                <xsl:value-of select="./*[local-name()=$geom_type]/*[local-name()='Stroke']/*[local-name()='CssParameter' and @name='stroke-opacity']/text()"/>
            </xsl:element>
        </xsl:element>
        <xsl:element name="tr">
            <!-- Stroke - stroke-width -->
            <xsl:element name="td">
                <xsl:value-of select="./*[local-name()=$geom_type]/*[local-name()='Stroke']/*[local-name()='CssParameter' and @name='stroke-width']/text()"/>
            </xsl:element>
        </xsl:element>
        <xsl:element name="tr">
            <!-- Stroke - stroke-linejoin -->
            <xsl:element name="td">
                <xsl:value-of select="./*[local-name()=$geom_type]/*[local-name()='Stroke']/*[local-name()='CssParameter' and @name='stroke-linejoin']/text()"/>
            </xsl:element>
        </xsl:element>
        <xsl:element name="tr">
            <!-- Stroke - stroke-dasharray -->
            <xsl:element name="td">
                <xsl:value-of select="./*[local-name()=$geom_type]/*[local-name()='Stroke']/*[local-name()='CssParameter' and @name='stroke-dasharray']/text()"/>
            </xsl:element>
        </xsl:element>
        <xsl:element name="tr">
            <!-- Stroke - stroke-linecap -->
            <xsl:element name="td">
                <xsl:value-of select="./*[local-name()=$geom_type]/*[local-name()='Stroke']/*[local-name()='CssParameter' and @name='stroke-linecap']/text()"/>
            </xsl:element>
        </xsl:element>
        <xsl:element name="tr">
        ...
        <xsl:element name="tr">
            ...
            <xsl:element name="td">
                <xsl:value-of select="./*[local-name()=$geom_type]/*[local-name()='Graphic']/*[local-name()='Mark']/*[local-name()='Fill']/*[local-name()='CssParameter' and @name='fill']/text()"/>
            </xsl:element>
        </xsl:element>
        <xsl:element name="tr">
            <!-- Graphic - Mark - Fill - fill-opacity -->
            <xsl:element name="td">
                <xsl:value-of select="./*[local-name()=$geom_type]/*[local-name()='Graphic']/*[local-name()='Mark']/*[local-name()='Fill']/*[local-name()='CssParameter' and @name='fill-opacity']/text()"/>
            </xsl:element>
        </xsl:element>
        <xsl:element name="tr">
            <!-- Graphic - Mark - Stroke - stroke -->
            <xsl:element name="td">
                <xsl:value-of select="./*[local-name()=$geom_type]/*[local-name()='Graphic']/*[local-name()='Mark']/*[local-name()='Stroke']/*[local-name()='CssParameter' and @name='stroke']/text()"/>
            </xsl:element>
        </xsl:element>
        <xsl:element name="tr">
            <!-- Graphic - Mark - Stroke - stroke-opacity -->
            <xsl:element name="td">
                <xsl:value-of select="./*[local-name()=$geom_type]/*[local-name()='Graphic']/*[local-name()='Mark']/*[local-name()='Stroke']/*[local-name()='CssParameter' and @name='stroke-opacity']/text()"/>
            </xsl:element>
        </xsl:element>
        <xsl:element name="tr">
            <!-- Graphic - Mark - Stroke - stroke-width -->
            <xsl:element name="td">
                <xsl:value-of select="./*[local-name()=$geom_type]/*[local-name()='Graphic']/*[local-name()='Mark']/*[local-name()='Stroke']/*[local-name()='CssParameter' and @name='stroke-width']/text()"/>
            </xsl:element>
        </xsl:element>
        <xsl:element name="tr">
            <!-- Graphic - Size -->
